...
create index audit_logs_module_created_idx on public.audit_logs (module, created_at desc);
...
create table public.champion_spotlight (
  id int primary key default 1 check (id = 1),
  is_active boolean not null default false,
...
alter publication supabase_realtime add table public.champion_spotlight;
alter publication supabase_realtime add table public.champion_history;
