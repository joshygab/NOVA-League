  ...
  return (
    <main className="mx-auto grid min-h-[70vh] max-w-md place-items-center">
      <form onSubmit={handleSubmit} className="panel w-full p-6">
        ...
        <p className="mt-2 text-sm text-slate-400">Entra con tu correo y contraseña para ver tu perfil.</p>
        ...
        <Link to="/registro" className="button-secondary mt-3 w-full">No tengo cuenta, registrarme</Link>
      </form>
    </main>
  )
}
